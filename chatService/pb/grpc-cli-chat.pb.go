...
type RoomListResponse struct {
	...
	RoomList map[int32]string `protobuf:"bytes,1,rep,name=RoomList,proto3" json:"RoomList,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // map[RoomNumber]RoomName
}
